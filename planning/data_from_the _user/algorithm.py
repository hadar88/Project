def calculate_macros(goal, activity_type, activity_level, daily_calories):
    ...
    x1, x2, x3, x4 = 0.5, 0.05, 0.3, 0.2

    # Step 1: Adjust calories based on goal
    if goal == "lose":
        adjusted_calories = 0.85 * daily_calories
    elif goal == "gain":
        adjusted_calories = 1.15 * daily_calories
    else:  # "maintain"
        adjusted_calories = daily_calories

    # Step 2: Adjust macronutrients based on activity type
    ...
    # Step 3: Adjust macronutrients based on activity level
